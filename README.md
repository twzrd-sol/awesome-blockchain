...
- [TWZRD Agent Intel](https://intel.twzrd.xyz) - MCP server for on-chain trust scoring of AI agent wallets on Solana. Verify agent identity and autonomy before x402 micropayments.
### Exchanges
